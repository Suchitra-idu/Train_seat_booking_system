...
# A counter sale is created already paid, CONFIRMED with a seat or STANDING without one
# (D23), so there is no unpaid state to transition out of. Both can still be cancelled.
